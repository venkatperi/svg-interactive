(function ( $ ) {
    ...
    init : function ( options ) {
      ...
      container.find( '.md-btn' ).click( function () {
        ...
        if ( btnType === 'h1' ) {
          ...
          // defaults.onPreview( editor.getSession().getValue()
              // , function ( content ) { mdPreview.html( content ); }
          // );
  ...
  function setShortcuts( editor, snippetManager ) {
    ...
    editor.commands.addCommand( {
      ...
      exec : function ( editor ) {
        onUpdate( editor.getSession().getValue() );
      },
      readOnly : false
    } );
  ...
  function editorHtml( content, options ) {
    ...
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnHeader1
            + '" class="md-btn btn btn-sm btn-default" data-btn="h1">H1</button>';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnHeader2
            + '" class="md-btn btn btn-sm btn-default" data-btn="h2">H2</button>';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnHeader3
            + '" class="md-btn btn btn-sm btn-default" data-btn="h3">H3</button>';
    html += '</div>'; // .btn-group

    html += '<div class="btn-group">';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnBold
            + '" class="md-btn btn btn-sm btn-default" data-btn="bold"><span class="glyphicon glyphicon-bold"></span></button>';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnItalic
            + '" class="md-btn btn btn-sm btn-default" data-btn="italic"><span class="glyphicon glyphicon-italic"></span></button>';
    html += '</div>'; // .btn-group

    html += '<div class="btn-group">';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnList
            + '" class="md-btn btn btn-sm btn-default" data-btn="ul"><span class="glyphicon glyphicon glyphicon-list"></span></button>';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnOrderedList
            + '" class="md-btn btn btn-sm btn-default" data-btn="ol"><span class="glyphicon glyphicon-th-list"></span></button>';
    html += '</div>'; // .btn-group

    html += '<div class="btn-group">';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnLink
            + '" class="md-btn btn btn-sm btn-default" data-btn="link"><span class="glyphicon glyphicon-link"></span></button>';
    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnImage
            + '" class="md-btn btn btn-sm btn-default" data-btn="image"><span class="glyphicon glyphicon-picture"></span></button>';
    if ( options.imageUpload === true ) {
      html += '<div data-mdtooltip="tooltip" title="' + options.label.btnUpload
    ...
    */
    ...
    if ( options.fullscreen === true ) {
      ...
      html +=
          '<button type="button" class="md-btn btn btn-sm btn-default" data-btn="fullscreen"><span class="glyphicon glyphicon-fullscreen"></span> '
          + options.label.btnFullscreen + '</button>';
      html += '</div>'; // .btn-group
    }
    ...
    if ( options.preview === true ) {
      html += '<div class="btn-group pull-right">';
      // html +=
      //     '<button type="button" class="md-btn btn btn-sm btn-default btn-edit active" data-btn="edit"><span class="glyphicon glyphicon-pencil"></span> '
      //     + options.label.btnEdit + '</button>';
      html +=
          '<button type="button" class="md-btn btn btn-sm btn-default btn-preview" data-btn="preview"><span class="glyphicon glyphicon-eye-open"></span> '
          + options.label.btnPreview + '</button>';
      html += '</div>'; // .btn-group
    }
